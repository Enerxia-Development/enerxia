...
<div class="jshop" id="comjshop_register">
    ...
    <h1 class="jShopRegisterTitle"><?php print _JSHOP_REGISTRATION;?></h1>
    <?php } ?>
    ...
    <div class="jShopLoginField jShopRegister"><input type = "submit" value = "<?php print _JSHOP_SEND_REGISTRATION ?>" class = "button" /></div>
    </form>
</div>