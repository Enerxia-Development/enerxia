	...
	<fieldset class="word">
		...
		<div class="form-group">
			<?php if ($this->escape($this->query->input) != '' || $this->params->get('allow_empty_search')):?>
				<button id="smartsearch-btn" name="Search" type="submit" class="btn btn-primary"><?php echo JText::_('JSEARCH_FILTER_SUBMIT');?></button>
			<?php else: ?>
			...
			<?php endif; ?>
			<?php if ($this->params->get('show_advanced', 1)) : ?>
				<a href="#advancedSearch" data-toggle="collapse" class="btn btn-default"> <?php echo JText::_('COM_FINDER_ADVANCED_SEARCH_TOGGLE'); ?></a>
			<?php endif; ?>
		</div>
	</fieldset>
