		...
		<form action="<?php echo JURI::root(true); ?>/index.php" enctype="multipart/form-data" method="post" id="josForm" name="josForm" class="form-validate">
			...
			<div>
				<div>
					...
					<div class="heading_login_page"><?php echo JText::_('BT_ARISE2_K2_CREATE_AN_ACCOUNT'); ?></div>
					...
					<!--<div class="heading_login_page" style="margin-bottom:15px;"><?php echo JText::_('K2_PERSONAL_DETAILS'); ?></div>-->
					<!-- K2 attached fields -->
					...
					<div class="control-group">
						...
						<div class="register-fields-input">
							<input class="inputbox" type="text" size="50" value="<?php echo $this->K2User->url; ?>" name="url" id="url"/>
						</div>
					</div>
						...
						<?php if (count($fields)):?>
							...
							<?php foreach($fields as $field):// Iterate through the fields in the set and display them.?>
								<?php if ($field->hidden):// If the field is hidden, just display the input.?>
									<div class="control-group"><div class="register-fields-input"><?php echo $field->input;?></div></div>
								<?php else:?>
									<div class="control-group">
										<div class="control-label">
