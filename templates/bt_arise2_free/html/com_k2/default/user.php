...
<div id="k2Container" class="userView<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
	...
	<div class="userBlock">
		...
		<div class="userBlockInfo">
				...
				<h2 class="userBlockName"><?php echo $this->user->name; ?></h2>
				<?php endif; ?>
	...
	<div class="userItemList">
		...
		<div class="userItemView<?php if(!$item->published || ($item->publish_up != $this->nullDate && $item->publish_up > $this->now) || ($item->publish_down != $this->nullDate && $item->publish_down < $this->now)) echo ' userItemViewUnpublished'; ?>">
		...
		<div class="k2ItemBody">	
			...
			<div class="k2ItemInfo">
				...
				<div class="userItemDateCreated">
					<?php echo JText::_('K2_POST_ON'); ?><?php echo JHTML::_('date', $item->created , JText::_('K2_DATE_CREATED')); ?>
				</div>
				<?php endif; ?>
