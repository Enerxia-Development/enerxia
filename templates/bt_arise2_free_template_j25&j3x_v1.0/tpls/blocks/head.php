...
<link href="<?php echo T3_TEMPLATE_URL ?>/css/style_bt_arise2_free.css" rel="stylesheet" />
<link href="<?php echo T3_TEMPLATE_URL ?>/css/effect.css" rel="stylesheet" />
<?php if (version_compare(JVERSION, '3.0', '>=')) { ?>
	<link href="<?php echo T3_TEMPLATE_URL ?>/css/j3x_css.css" rel="stylesheet" />
<?php } ?>

<link href="<?php echo T3_TEMPLATE_URL ?>/css/reponsive.css" rel="stylesheet" />
