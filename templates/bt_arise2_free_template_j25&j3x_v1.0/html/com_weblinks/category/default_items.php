	...
	<?php endif; ?>
		<ul class="category list-unstyled">
			...
			<?php foreach ($this->items as $i => $item) : ?>
				...
				<div class="weblinkItemHeader">
					<?php if ($this->params->get('show_link_hits', 1)) : ?>
						<div class="webLinkItemHit">
							<?php echo $item->hits; ?>
						</div>
					<?php endif; ?>
				...
				<div class="weblinkItemTitle">	
					<h3 class="list-title">
						...
						?>
							...
							<div class="showLink">
								<?php echo JText::_('COM_WEBLINKS_LINK'); ?>: <?php echo '<a href="'.  $link . '" class="'. $menuclass .'" rel="nofollow">'.
											$this->escape($item->url) . ' </a>'; ?>
							</div>
						</div>
					</div>	
