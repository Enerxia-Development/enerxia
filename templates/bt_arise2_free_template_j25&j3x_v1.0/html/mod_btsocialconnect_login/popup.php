	...
	<div class="btl-panel">
		...
		<?php else : ?>
			...
			<span class="btl-panel-button">
				<!-- Login button -->
				<span id="btl-panel-login" href="#btl-content-login" class="<?php echo $effect;?>">
				...
				?>
				<span id="btl-panel-registration" href="#btl-content-registration" class="<?php echo $effect;?>">
					<span><?php echo JText::_('JREGISTER');?></span>
				</span>
				<?php }
				} ?>
			</span>
	...
	<div id="btl-content">
		...
		<div id="btl-content-profile" class="btl-content-block">
			...
			<div class="btl-buttonsubmit">
				<form action="<?php echo JRoute::_('index.php', true, $params->get('usesecure')); ?>" method="post" name="logoutForm" id="logout-form">
					<button name="Submit" title="<?php echo JText::_('MOD_BTSOCIALCONNECT_FIELD_LOGOUT');?>" class="btl-buttonlogout" onclick="javascript:logout_button_click();return false;"><?php echo JText::_('MOD_BTSOCIALCONNECT_FIELD_LOGOUT');?></button>
		...
		<div id="btl-content-login" class="btl-content-block">
			...
			<div id="btl-login-in-process"></div>	
				...
				<div class="btl-text social_button_text"><?php echo JText::_('SIGNIN_SOCIAL');?></div>
