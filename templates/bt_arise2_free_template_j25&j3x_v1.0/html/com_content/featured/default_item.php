...
<div class="articleItem">
	...
	<?php  if (isset($images->image_intro) and !empty($images->image_intro)) : ?>
		...
		<div class="img-intro-ft align-image-<?php echo htmlspecialchars($imgfloat); ?>">
		<img
...
<div class="articleItemBody_ft">

<?php if ($params->get('show_title')) : ?>
	<h2 class="articleTitle_ft">
...
<?php /* if (($params->get('show_author') && !empty($this->item->author )) 
	...
	<div class="articleItemInfo_ft">
		<?php //if ($params->get('show_author') && !empty($this->item->author )) : ?>
			<div class="createdby_ft">
		...
		<?php if ($params->get('show_publish_date')) : ?>
			<div class="published">
				<?php echo JText::sprintf('COM_CONTENT_POST_ON'); echo (JHtml::_('date', $this->item->publish_up, JText::_('COM_CONTENT_DATE_CREATED'))); ?>
			</div>
		<?php endif; ?>
...
<?php // endif; ?>
	...
	<div class="articleIntrotext_ft"><?php echo $this->item->introtext; ?></div>
