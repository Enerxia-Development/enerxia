		...
		<?php if ($params->get('show_category')) : ?>
				<div class="category-name">
					...
					<?php if ($params->get('link_category')) : ?>
						<?php echo JText::sprintf('COM_CONTENT_POST_IN'); echo ($url); ?>
						<?php else : ?>
						<?php echo JText::sprintf('COM_CONTENT_POST_IN'); echo ($title); ?>
					<?php endif; ?>
				</div>
		<?php endif; ?>
...
<?php endif; ?>	
	...
	<div class="articleIntrotext"><?php echo $this->item->introtext; ?></div>
