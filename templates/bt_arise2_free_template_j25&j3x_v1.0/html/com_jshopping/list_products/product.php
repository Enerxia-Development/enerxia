...
<div class="productItemInner">
    <div class="image">
        ...
        <div class="image_block">
            ...
            <?php //}?>
            <a class="productImg" href="<?php print $product->product_link?>">
			...
			<div class="buttons">
				<!--<a class="button_detail" href="<?php print $product->product_link?>"><i class="fa fa-arrows"></i></a>
				<?php print $product->_tmp_var_buttons;?>-->
				<?php if ($product->buy_link){?>
				<a class="button_buy" href="<?php print $product->buy_link?>"><i class="fa fa-shopping-cart"></i></a>
				<?php }?>
    ...
    <div class="productItemListInfor">
		...
		<div class="productListCategory"><?php print $this->category->name; ?></div>
